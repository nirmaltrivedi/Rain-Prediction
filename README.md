This data science project is made to predict if rain is going to happen tomorrow or not. This is a classification project made using various python libraries and machine learning models.
